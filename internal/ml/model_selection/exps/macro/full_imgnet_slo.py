...
if __name__ == "__main__":
    ...
    # 10 days
    max_minute = 144000
    budget_array = log_scale_x_array(num_points=args.num_points, max_minute=max_minute, min_val=10)

    print(budget_array)
    if only_phase1:
        checkpoint_name = f"./internal/ml/model_selection/exp_result/imagenetfull/" \
