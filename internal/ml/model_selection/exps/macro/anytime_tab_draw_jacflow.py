...
def get_dataset_parameters(dataset):
    parameters = {
        "frappe": {
            "epoch": 19,
            "sys_end2end_res": "./internal/ml/model_selection/exp_result/jacflow/res_end_2_end_mlp_sp_frappe_-1_5_jacflow.json",
            ...
            "annotations": [["KNAS (Training-Free)", 97.94285967933458, 22.349602699279785 + 210]],
            "remove_n_points": 2,
        },
        "uci_diabetes": {
            "epoch": 0,
            "sys_end2end_res": "./internal/ml/model_selection/exp_result/jacflow/res_end_2_end_uci_diabetes_100_12_160k.json",
            ...
            "annotations": [["KNAS (Training-Free)", 65.43367453301122, 41.58024]],
            "remove_n_points": 2,
        },
        "criteo": {
            "epoch": 9,
            "sys_end2end_res": "./internal/ml/model_selection/exp_result/jacflow/res_end_2_end_criteo_100_12_15run.json",
            ...
            "figure_size": (6.8, 4.8),
            "datasetfg_name": dataset,
            "annotations": [["KNAS (Training-Free)", 80.20160802454794, 6277.039093732834]],
            "remove_n_points": 1,
        },
    }
...
def generate_and_draw_data(dataset):
    ...
    all_lines = [
        ...
        [system_p1_result["sys_time_budget"], system_p1_result["sys_acc"]],  # train-free
        [sampled_sys_x, sampled_sys_y],  # two-phase
    ]

    draw_structure_data_anytime_system_version(
        all_lines=all_lines,
